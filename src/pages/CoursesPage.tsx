...
const CoursesPage: React.FC = () => {
  ...
  const { 
    courses = [], 
    coursesPagination = { page: 0, size: 10, totalElements: 0, totalPages: 0 }, 
    categories = [], 
    loading = false, 
  ...
  useEffect(() => {
    ...
    console.log('CoursesPage: Fetching courses with filters:', initialFilters);
  ...
  useEffect(() => {
    ...
    console.log('CoursesPage: Filters changed, fetching courses:', currentFilters);
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {courses.map((course) => (
                <Card key={course.id} hoverable className="h-full flex flex-col">
                  <div 
                    className="cursor-pointer transition-transform hover:scale-105 flex-1 flex flex-col"
